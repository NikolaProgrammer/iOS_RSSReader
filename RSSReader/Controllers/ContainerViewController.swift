...
class ContainerViewController: UIViewController {
    ...
    private func showController() {
        ...
        case .aboutUs:
            let aboutUsController = storyboard?.instantiateViewController(withIdentifier: StoryBoardIds.aboutUs) as! AboutUsViewController
            navigationController.setViewControllers([aboutUsController], animated: true)
            aboutUsController.navigationItem.title = menuSection.rawValue
        default:
